...
; Copies the sprites before the offset at the actual end of the spratr buffer
	...
	push	de ; (preserves actual spratr buffer end)
	ld	b, 0 ; bc = offset
	ld	c, a
...
; Restores the original SPAT_END
	pop	hl ; (restores actual spratr buffer end)
	ld	[hl], SPAT_END
	ret
